...
```{r, warning=TRUE}
library(readr)
prb<-read_csv(file = "https://github.com/coreysparks/r_courses/raw/refs/heads/master/data/PRB2008_All.csv", col_types = read_rds("https://github.com/coreysparks/r_courses/raw/refs/heads/master/data/prbspec.rds"))
names(prb)<-tolower(names(prb))

library(dplyr)
prb<-prb%>%
  mutate(africa=ifelse(=="Africa", 1, 0))%>%
