...
```{r, warning=TRUE}
library(readr)
prb<-read_csv(file = "https://raw.githubusercontent.com/coreysparks/data/master/PRB2008_All.csv", col_types = read_rds("https://raw.githubusercontent.com/coreysparks/r_courses/master/prbspec.rds"))
