---
title: "Population Projection and the Lee-Carter Model"
---
...
```{r}
#| echo: false
mypassword="UJY.uxu9yam0rqn1cbh"
myusername="corey.sparks.utsa@gmail.com"
```

```{r}
UShmd<- readHMDweb(CNTRY = "USA", item ="fltper_5x5",fixup=T, password =mypassword,username = myusername)
...
```{r}
#| echo: false
myotherpassword="bwa7vku9RME8paw_bdp"
```
...
```{r}
ggplot(us_dem)+
     geom_line( aes(x=Age, y=asfr5), color="red")+
     geom_line( aes(x=Age, y=qx), color="blue")+
     xlim(0, 110)+ylab("Rate")+
     xlab("Age")+
     theme_minimal()
